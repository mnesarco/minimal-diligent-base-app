...
class ApplicationBackendUWP final : public ApplicationBackend
{
public:
    ApplicationBackendUWP()
    {
    ...
    virtual void OnSetWindow(Windows::UI::Core::CoreWindow^ window)override final
    {
        ...
        m_InputControllerEventHandlerUWP = InputControllerEventHandlerUWP::Create(window, m_TheApplication->GetInputController().GetSharedState());
    }
...
{
    return new ApplicationBackendUWP;
}
