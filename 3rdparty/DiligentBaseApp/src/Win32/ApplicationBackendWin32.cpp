...
class ApplicationBackendWin32 final : public ApplicationBackend
{
public:
    virtual LRESULT HandleWin32Message(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) override final
    {
        ...
        m_TheApplication->GetInputController().HandleNativeMessage(&MsgData);
        return m_TheApplication->HandleNativeMessage(&MsgData);
    }
...
protected:
    ...
    virtual void SetFullscreenMode(const Diligent::DisplayModeAttribs& DisplayMode) override
    {
        ...
        ApplicationBackend::SetFullscreenMode(DisplayMode);
    }
    ...
    virtual void SetWindowedMode() override
    {
        ...
        ApplicationBackend::SetWindowedMode();
    }
...
{
    return new ApplicationBackendWin32;
}
