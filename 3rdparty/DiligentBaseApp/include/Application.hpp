...
public:
    ...
    virtual void Initialize(const ApplicationInitInfo& InitInfo) = 0;
    ...
    virtual const Char* GetApplicationTitle() const { return "Diligent Engine Application"; }
...
inline void Application::Update(double CurrTime, double ElapsedTime)
{
    ++m_NumFramesRendered;
...
inline void Application::Initialize(const ApplicationInitInfo& InitInfo)
{
...
extern Application* CreateDiligentApplication();
